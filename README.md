...
약 12% 증가할 것으로 전망되고 있습니다. 이와 같은 증가추세는 가구 및 인테리어 제품의 구매 비율 또한 증가를 예상하여 가구, 인테리어 쇼핑몰 프로젝트를 진행하게 되었습니다.
또한, 커뮤니티 게시판을 추가하여 판매자가 아닌 구매자가 커뮤니티에서 다른 사람들의 구매 후기, 배치사진 등을 보면서 제품에 대한 신뢰가 쌓이고 바로 쇼핑으로 이어질 가능성을 높이기 위함 입니다.
